...
Installation steps, recommended setups, and guides for Zed.

---

## 🚀 Getting Started & CLI Setup
```bash
    # Setup and configurations for zed
    # Please add documentation inside tools/zed/README.md
```
...
| :--- | :--- | :--- |
| **Official Website** | https://google.com/search?q=zed | Search official download details |
